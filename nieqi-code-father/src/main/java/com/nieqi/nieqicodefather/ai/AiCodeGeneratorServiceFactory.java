...
import com.nieqi.nieqicodefather.ai.tools.*;
...
public class AiCodeGeneratorServiceFactory {
    ...
    private String buildCacheKey(long appId, CodeGenTypeEnum codeGenType) {
        String typeValue = codeGenType == null ? "UNKNOWN" : codeGenType.getValue();
        return appId + ":" + typeValue;
    }
    ...
    private AiCodeGeneratorService createAiCodeGeneratorService(long appId, CodeGenTypeEnum codeGenType) {
        ...
        return switch (codeGenType) {
            // Vue 项目和管理系统生成使用推理模型 + 工具
            case VUE_PROJECT, MANAGEMENT_SYSTEM -> AiServices.builder(AiCodeGeneratorService.class)
