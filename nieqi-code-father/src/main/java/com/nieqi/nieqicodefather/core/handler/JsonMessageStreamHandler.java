package com.nieqi.nieqicodefather.core.handler;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.nieqi.nieqicodefather.ai.model.message.*;
import com.nieqi.nieqicodefather.ai.tools.BaseTool;
import com.nieqi.nieqicodefather.ai.tools.ToolManager;
...
public class JsonMessageStreamHandler {
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    log.info("流式响应完成，保存对话历史并启动异步构建");
                    // 流式响应完成后，添加 AI 消息到对话历史
                    String aiResponse = chatHistoryStringBuilder.toString();
                    chatHistoryService.addChatMessage(appId, aiResponse, ChatHistoryMessageTypeEnum.AI.getValue(), loginUser.getId());
                    String projectPath = AppConstant.getCodeOutputRootDir() + "/" + codeGenType.getValue() + "_" + appId;
