...
import com.nieqi.nieqicodefather.common.DeleteRequest;
...
import com.nieqi.nieqicodefather.model.dto.user.*;
import com.nieqi.nieqicodefather.model.vo.LoginUserVO;
...
public class UserController {
    ...
    @Value("${user.default-password:12345678}")
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        validateCaptcha(userRegisterRequest.getCaptchaKey(), userRegisterRequest.getCaptchaCode());
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        validateCaptcha(userLoginRequest.getCaptchaKey(), userLoginRequest.getCaptchaCode());
    ...
    private void validateCaptcha(String captchaKey, String captchaCode) {
        ...
        String cached = stringRedisTemplate.opsForValue().get("captcha:" + captchaKey);
        if (cached == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "验证码已过期，请刷新重试");
        }
        if (!cached.equalsIgnoreCase(captchaCode)) {
