...
import com.nieqi.nieqicodefather.model.dto.app.*;
import com.nieqi.nieqicodefather.model.entity.User;
import com.nieqi.nieqicodefather.model.vo.AppVO;
import com.nieqi.nieqicodefather.ratelimiter.annotation.RateLimit;
import com.nieqi.nieqicodefather.ratelimiter.enums.RateLimitType;
import com.nieqi.nieqicodefather.service.ProjectDownloadService;
...
public class AppController {
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "应用代码下载失败：" + e.getMessage());
        }
    }
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.nieqi.nieqicodefather.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
